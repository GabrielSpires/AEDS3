...
void *sum_vetor(void *param)
{
	...
	/*soma parte do vetor - como essa eh a parte critica do codigo,
	 na qual as duas threads podem tentar escrever na mesma variavel,
	 colocamos o mutex nesse ponto para garantir que apenas uma das
	 threads consiga modificar a variavel soma total por vez*/
